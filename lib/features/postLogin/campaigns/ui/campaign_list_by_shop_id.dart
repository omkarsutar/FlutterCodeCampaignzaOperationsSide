...
class CampaignListByShopId extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CampaignListByShopId> createState() =>
      _CampaignListByShopIdState();
}

class _CampaignListByShopIdState extends ConsumerState<CampaignListByShopId> {
