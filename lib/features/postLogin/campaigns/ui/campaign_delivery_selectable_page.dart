...
class CampaignDeliverySelectablePage extends ConsumerWidget {
  final List<ModelCampaign> orders;
  final dynamic adapter;

  const CampaignDeliverySelectablePage({
    super.key,
            ...
            ...items.asMap().entries.map((entry) {
              ...
              return TableRow(
                children: [
                  ...
                  _buildCell(
                    CampaignDeliverySelectablePage._formatQuantity(
                      item.itemQty,
                    ),
                    alignRight: true,
                  ),
