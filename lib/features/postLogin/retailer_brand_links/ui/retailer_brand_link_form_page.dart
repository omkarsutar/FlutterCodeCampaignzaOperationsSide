...
/// Custom Form Page for Retailer Brand Link
/// Filters users to only show those with 'retailer' role
class RetailerBrandLinkFormPage<T> extends ConsumerStatefulWidget {
  ...
  const RetailerBrandLinkFormPage({
    super.key,
    this.entityId,
  ...
  @override
  ConsumerState<RetailerBrandLinkFormPage<T>> createState() =>
      _RetailerBrandLinkFormPageState<T>();
}

class _RetailerBrandLinkFormPageState<T>
    extends ConsumerState<RetailerBrandLinkFormPage<T>> {
  ...
  Future<void> _loadRetailers(GenericFormController controller) async {
    try {
      ...
      if (roleRes == null) {
        debugPrint('RetailerBrandLinkFormPage: Retailer role not found');
        return;
      }
