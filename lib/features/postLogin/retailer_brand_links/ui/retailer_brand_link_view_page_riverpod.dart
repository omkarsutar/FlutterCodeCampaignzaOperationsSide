...
/// Retailer Brand Link Riverpod version of Entity View Page
class RetailerBrandLinkViewPageRiverpod<T> extends ConsumerWidget {
  ...
  const RetailerBrandLinkViewPageRiverpod({
    super.key,
