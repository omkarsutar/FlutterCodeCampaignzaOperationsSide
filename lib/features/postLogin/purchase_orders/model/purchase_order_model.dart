...
class ModelPurchaseOrder {
  ...
  Map<String, dynamic> toMap() {
    ...
    if (poRouteId != null) {
      map[ModelPurchaseOrderFields.poRouteId] = poRouteId;
    }
    if (poShopId != null) {
      map[ModelPurchaseOrderFields.poShopId] = poShopId;
    }
    if (userComment != null) {
    ...
    if (poLat != null) {
      map[ModelPurchaseOrderFields.poLat] = poLat;
    }
    if (poLong != null) {
      map[ModelPurchaseOrderFields.poLong] = poLong;
    }
