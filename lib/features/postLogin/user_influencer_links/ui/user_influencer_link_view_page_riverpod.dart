...
/// User Influencer Link Riverpod version of Entity View Page
class UserInfluencerLinkViewPageRiverpod<T> extends ConsumerWidget {
  ...
  const UserInfluencerLinkViewPageRiverpod({
    super.key,
